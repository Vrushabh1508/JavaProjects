...
public class Project extends JFrame implements ActionListener {
	...
	Project() {
		...
		ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Images1/payroll.jpg"));
		...
		t1.setIcon(new ImageIcon(ClassLoader.getSystemResource("Images2/New.png")));

		JMenuItem t3 = new JMenuItem("Salary");
		t3.setForeground(Color.blue);
		t3.setFont(new Font("monospaced", Font.PLAIN, 12));
		t3.setMnemonic('S');
		t3.setIcon(new ImageIcon(ClassLoader.getSystemResource("Images1/schedreport.png")));
		...
		t4.setMnemonic('L');
		t4.setIcon(new ImageIcon(ClassLoader.getSystemResource("Images1/newinvoice.png")));
		...
		s1.setMnemonic('U');
		s1.setIcon(new ImageIcon(ClassLoader.getSystemResource("Images2/EditOpen.png")));
		...
		s2.setMnemonic('p');
		s2.setIcon(new ImageIcon(ClassLoader.getSystemResource("Images1/empreport.png")));
		...
		s3.setMnemonic('T');
		s3.setIcon(new ImageIcon(ClassLoader.getSystemResource("Images1/EXPENSE.PNG")));
		...
		p1.setMnemonic('P');
		p1.setIcon(new ImageIcon(ClassLoader.getSystemResource("Images1/payments.png")));
		...
		p2.setMnemonic('L');
		p2.setIcon(new ImageIcon(ClassLoader.getSystemResource("Images1/empreport.png")));
		...
		u1.setIcon(new ImageIcon(ClassLoader.getSystemResource("Images2/New.png")));
		...
		u2.setIcon(new ImageIcon(ClassLoader.getSystemResource("Images1/calc.png")));
		...
		u3.setIcon(new ImageIcon(ClassLoader.getSystemResource("Images1/explorer.jpg")));
		...
		m8i1.setMnemonic('X');
		m8i1.setIcon(new ImageIcon(ClassLoader.getSystemResource("Images1/exit.PNG")));
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (msg.equals("New Employee"))
			...
			new SalaryClass().setVisible(true);
